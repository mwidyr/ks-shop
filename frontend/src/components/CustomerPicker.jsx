    ...
    <div>
      ...
      {mode === 'search' ? (
        <div className="relative">
          ...
          {selected && (
            <p className="text-xs text-green-600 mt-1">{t('shared.customer_selected', { name: selected.name, phone: selected.phone })}</p>
          )}
        </div>
      ) : (
